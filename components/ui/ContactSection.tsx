...
export default function ContactSection() {
  return (
    <section id="contact" className="min-h-screen py-20 px-4 md:px-8 bg-background">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 rounded-full bg-[var(--accent)]/10 hover:bg-[var(--accent)]/20 transition-colors">
        ...
        <footer className="mt-20 pt-8 border-t border-primary/20">
          <div className="text-center text-foreground/60">
            <p>&copy; {new Date().getFullYear()} Trade Craft. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </section>
